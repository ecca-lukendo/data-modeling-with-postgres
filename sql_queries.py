...
songplay_table_create = ("CREATE TABLE IF NOT EXISTS songplays(songplay_id SERIAL PRIMARY KEY, start_time varchar NOT NULL, user_id int NOT NULL, \
...
artist_table_create = ("CREATE TABLE IF NOT EXISTS artists(artist_id varchar PRIMARY KEY, name varchar, location varchar, latitude numeric, \
	longitude numeric);")

time_table_create = ("CREATE TABLE IF NOT EXISTS time(start_time varchar PRIMARY KEY, hour int, day int, week int, month int, year int, \
	weekday int);")
...
time_table_insert = ("INSERT INTO time(start_time, hour, day, week, month, year, weekday) VALUES (%s, %s, %s, %s, %s, %s, %s) \
	ON CONFLICT(start_time) DO UPDATE SET hour = EXCLUDED.hour, day = EXCLUDED.day, week = EXCLUDED.week, month = EXCLUDED.month, \
	year = EXCLUDED.year, weekday = EXCLUDED.weekday;")

# FIND SONGS

song_select = ("SELECT s.song_id AS song_id, a.artist_id AS artist_id FROM songs s JOIN artists a ON s.artist_id = a.artist_id \
